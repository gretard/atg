...
public class MethodBranch implements Serializable {
	...
	public boolean isSimple() {
		return Objects.equals(this.leftType, "null_type") || Objects.equals(this.rightType, "null_type")
				|| Objects.equals(this.leftType, "boolean") || Objects.equals(this.rightType, "boolean");
