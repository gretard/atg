...
public class CalculatorAtgTest {
    ...
    public final void test0() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertEquals((double) -1.0d, sut_5, 0.001d);
        org.junit.Assert.assertEquals((double) -1.0d, sut_7, 0.001d);
        org.junit.Assert.assertEquals((int) 10, sut_9);
    }
    ...
    public final void test2() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertNotNull("Expected item sut_0 to be NOT null", sut_0);
        org.junit.Assert.assertNotNull("Expected item sut_2 to be NOT null", sut_2);
        org.junit.Assert.assertEquals((double) 0.0d, sut_5, 0.001d);
        org.junit.Assert.assertEquals((double) 0.0d, sut_7, 0.001d);
        org.junit.Assert.assertEquals((int) 10, sut_9);
    }
    ...
    public final void test3() throws java.lang.Throwable {
        ...
        org.junit.Assert.assertNotNull("Expected item sut_0 to be NOT null", sut_0);
        org.junit.Assert.assertNotNull("Expected item sut_2 to be NOT null", sut_2);
        org.junit.Assert.assertEquals((double) 1.7976931348623157E308d, sut_5, 0.001d);
        org.junit.Assert.assertEquals((double) 1.7976931348623157E308d, sut_7, 0.001d);
        org.junit.Assert.assertEquals((int) 10, sut_9);
    }
