...
public class ArrayCalculatorAtgTest {
    ...
    public final void test4() throws java.lang.Throwable {
        final int sut_0 = edu.ktu.atg.example.ArrayCalculator.sum(new int[] { (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0, (int) 0 });
        org.junit.Assert.assertEquals((int) 0, sut_0);
    }
